...
const styles = {
  ...
  loading: { color: "#64748b" }, grid: { display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(330px, 1fr))", gap: "24px", alignItems: "stretch" },
  ...
  features: { display: "flex", flexDirection: "column", gap: "13px", marginBottom: "26px" }, feature: { display: "flex", alignItems: "flex-start", gap: "10px", fontSize: "14px", lineHeight: 1.35 },
