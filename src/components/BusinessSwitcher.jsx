...
const styles = {
  ...
  card: { width: "100%", minWidth: 0, boxSizing: "border-box", display: "flex", alignItems: "center", gap: "clamp(12px, 4vw, 16px)", padding: "clamp(14px, 4vw, 18px)", borderRadius: "16px", border: "1px solid rgba(110,255,178,.32)", background: "linear-gradient(155deg, #1b6b46 0%, #2eb870 100%)", color: "#fff", textAlign: "left", cursor: "pointer", font: "inherit", overflow: "hidden", boxShadow: "0 8px 20px rgba(0,219,77,.14), 0 0 12px rgba(46,184,112,.12), inset 0 1px 0 rgba(255,255,255,.06)" },
