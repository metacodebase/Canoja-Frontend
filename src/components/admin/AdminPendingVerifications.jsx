  ...
  return (
    <AdminShell>
      <div className="admin-queue-page admin-pending-verifications-page" style={{
        ...
        {/* Sticky header */}
        <div className="admin-queue-header" style={{
          ...
          <div style={{
            ...
            <h1 style={{
              fontSize: "28.8px", fontWeight: 800, color: C.textPrimary,
              letterSpacing: "-0.576px", margin: 0
            }}>
          ...
          <div className="admin-queue-search-wrap"
        ...
        <div className="admin-queue-body" style={{ padding: "24px", display: "flex", flexDirection: "column", gap: "24px" }}>
          ...
          <div className="admin-queue-content" style={{ display: "grid", gridTemplateColumns: "300px minmax(0,1fr)", gap: "18px" }}>
            ...
            {/* Filter panel */}
            <div className="admin-queue-filters" style={{
                ...
                <ConfigProvider theme={{ components: { Table: { headerBg: "#f1f7f4", headerColor: "#617182", headerSplitColor: "transparent", borderColor: "#dce7e1", rowHoverBg: "#f7fbf9", cellPaddingBlock: 16, cellPaddingInline: 16 } } }}>
                  <Table
                    ...
                    rowSelection={{
                      ...
                      getCheckboxProps: () => ({ disabled: bulkApproving }),
                    }}
                    onRow={row => ({
