...
const styles = {
  ...
  card: { width: "100%", minWidth: 0, boxSizing: "border-box", display: "flex", alignItems: "center", gap: "clamp(12px, 4vw, 16px)", padding: "clamp(14px, 4vw, 18px)", borderRadius: "16px", border: "1px solid rgba(255,255,255,0.10)", background: "rgba(255,255,255,0.055)", color: "#fff", textAlign: "left", cursor: "pointer", font: "inherit", overflow: "hidden" },
